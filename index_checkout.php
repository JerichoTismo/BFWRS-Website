         ...
         <div id="content ">
            ...
            ?>
                        ...
                        <div class='order-message-container' style = "position:fixed; top:0;left:20em;min-height: 80vh; overflow-y:hidden;overflow-x:hidden; padding:2rem;display:flex; align-items:center;justify-content:center;z-index:1100;background-color:white;width:70%;margin-top:5rem;flex-direction:column;">
                           ...
                           <div class="order-detail" style = "background-color:var(--bg-color);border-radius: .5rem; padding:0rem;margin:1rem 0;padding-right:5rem; padding:0 15%">
                           ...
                           <center>
                           <div>
                              <a href='index_shop_end.php' class='btn btn-primary'>Continue Shopping</a>
                              
                              <a href='index_end.php' class='btn btn-primary'>Back to Homepage</a>
                           </div>
                           </center>
                              ...
                              <div class="form-group">
                                 ...
                                 <div class="form-group">
                                    <div class="form-group">
                                       ...
                                       <input class="form-control form-control-user" type="text" placeholder="Enter Your Full Name" name="fullName" required>
                                    </div>
                                    <div class="form-group">
                                       <input class="form-control form-control-user" type="number" placeholder="enter your number" name="phoneNo" required>
                                    </div>
                                    <div class="form-group">
                                       <input class="form-control form-control-user" type="email" placeholder="enter your email" name="email" required>
                                    </div>

                                    <div class="form-group row">
                                       <div class="col-sm-4 mb-3 mb-sm-0">

                                          <input class="form-control form-control-user" type="text" placeholder="House No." name="houseNo" required>
                                       </div>

                                       <div class="col-sm-4">

                                          <input class="form-control form-control-user" type="text" placeholder="Subdivision" name="subdivision" required>
                                       </div>
                                       <div class="col-sm-4">
                                    ...
                                    <div class="form-group row">
                                       <div class="col-sm-6 mb-3 mb-sm-0">
                                          ...
                                          <input class="form-control form-control-user" type="text" placeholder="Barangay" name="barangay" required>
                                       </div>
                                       <div class="col-sm-6">
